...
export interface DiamondGovernanceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "UPGRADE_ADMIN_ROLE"
...
export interface DiamondGovernance extends BaseContract {
  connect(runner?: ContractRunner | null): DiamondGovernance;
  waitForDeployment(): Promise<this>;

  interface: DiamondGovernanceInterface;
